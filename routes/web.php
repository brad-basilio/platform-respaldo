...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('can:admin')->group(function () {
        ...
        Route::get('/admin/scheduled-practices', [ScheduledClassController::class, 'indexPractices'])->name('admin.scheduled-practices.index');
        ...
        Route::get('/admin/practice-requests', [AdminClassRequestController::class, 'indexPractices'])->name('admin.practice-requests.index');
