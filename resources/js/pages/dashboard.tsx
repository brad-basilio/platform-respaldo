...
import { Users, DollarSign, Award, UserCheck, Clock, TrendingUp } from 'lucide-react';
...
const Dashboard: React.FC<Props> = () => {
  const { auth, stats, salesAdvisor, dailyStudents = [], prospectDistribution = [] } = usePage().props as Props;
  ...
  // Dashboard para otros roles (Cashier, etc)
